...
import com.app.msg.iso.JSONException;
import com.app.msg.iso.JSONObject;
import com.app.msg.iso.MessageTranslator;

@CrossOrigin(origins="*",allowedHeaders = "*")
@RestController
@RequestMapping(value="/isomsg")
public class IsoMsgController {
	
	private static final org.slf4j.Logger LOGGER=LoggerFactory.getLogger(IsoMsgController.class);
	...
	@GetMapping(value="/isoTojson/{iso}")
	public  String isoTojson(@PathVariable ("iso")String iso1) throws IOException {
		...
		try 
		{
			...
			if(iso != null) {
			json = mt.parseISO8583(iso1, config);
			}
	...
	@GetMapping(value="/jsoniso")
	public  String jsoniso() throws IOException {
	...
	public  String jsonxml() throws IOException {
...
public String convertXmlToJson(@RequestParam("xmlmessage") String message) {
	...
	try {
        ...
        // Object str=jsonObject.get("FCUBS_HEADER");
       //  Object str= jsonObject.getString("FCUBS_HEADER");
...
public String convertJsonToXml(@RequestParam(value="jsonmessage") String message) {
